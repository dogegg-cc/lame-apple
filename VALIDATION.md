...
日期：2026-08-27。本记录针对首版 0.1.0 的本地构建，不表示远端版本已经发布。
...
- `build-info.json` SHA-256：`efd56706b47f81f381f2bde55ce7c3b1e8f266b565b0d17e406f4993745f134e`。
...
| 本地 SPM 消费者 Release 构建 | iOS arm64 与模拟器 arm64 均通过 |
...
- AetherEngine 同时链接、FileBox 音频导出业务迁移。
- 远端 SPM 下载与公开 Release。
